...
par(mfcol=c(1,1),mar=c(3, 3, 0, 0),mgp=c(2.,.5,0),oma = c(rep(0.1,4)),cex=2)
matplot(x=1/t_ms,y=cbind(f_Eps,f_Ips,f_ms1,f_R),type="b",ylim=c(0,1),pch=19,col=c(1,2,7,4),las=1,
